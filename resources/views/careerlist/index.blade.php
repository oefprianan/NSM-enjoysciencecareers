        ...
        <div class="row">
            <div class="content-tab col-lg-11 col-md-11 col-sm-12 mx-auto">
                ...
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button type="button" class="nav-link" name="{{$value->category_career_name}}" value="{{$value->category_career_id}}">{{$value->category_career_name}}</button>
                    </li>
                    @endforeach
...
<script>
    $(document).ready(function() {
        $("button").click(function() {
            ...
            document.getElementById("catagory_show").innerHTML = '<h3>' + category_career_name + '</h3>';
            fetch_data();
